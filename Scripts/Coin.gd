...
@export var coin_event_name = "Play_Coin"
...
@onready var ak_name_obj = "Coin" + str(hash(self))
# ---------- FUNCTIONS ---------- #

func _ready():
	initial_position = position
	Wwise.register_game_obj(self, ak_name_obj)
...
func _on_body_entered(body):
	...
	if body.is_in_group("Player"):
		...
		Wwise.post_event(coin_event_name, self)
		queue_free()
